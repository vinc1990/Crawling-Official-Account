...
def downloadJPG(jpgfolder, url):
	...
	src_list = html.xpath("//div[contains(@class,'rich_media_content')]//p//img[contains(@class,'rich_pages')]/@data-src")
	for index,img_url in enumerate(src_list):
	    with open(jpgfolder + str(index+1) + ".jpg",'wb') as f:
	        f.write(requests.get(img_url).content)
	        print("正在下载第" + str(index +1) + "页\n", "地址：" + img_url)
...
if __name__ == "__main__":
    ...
    url ="https://mp.weixin.qq.com/s/zqLr39DGggLP_hdQPoBtZQ"
